    ...
    style="width: 100%">
      <el-table-column
        ...
        <template slot-scope="scope">
          <span style=""v-if="!(scope.row[v.prop] instanceof Object)" v-html='dayHourFormatter(scope.row[v.prop])'></span>

          <el-button
          v-for="(v,k) in scope.row[v.prop]"
          type="text"
          :class="{disagree:v.type=='disagree',corlor6:v.type=='haveagreed'||v.type=='haverefused'}"
          :key="k"
          v-if="v.permiss"
