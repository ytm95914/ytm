    ...
    export default {
        ...
        data(){
            return {
                ...
                tableHead: [
                    { label: "指标分类名称", prop: "realname"},
                    { label: "指标分类编号",  prop: "username" },
                    { label: "指标分类描述", prop: "projectName"},
                ],
                tableDtats: [],
                tableOperation: [
