<template>
    <section class="dialog">
        <el-button type="text" @click="dialogFormVisible = true">导入弹框</el-button>
        <el-dialog
            class="dialogframe"
            title="导入打卡记录"
            ...
            <section class="uploadContent">
                ...
                <div class="uploadContent-info">
                    <p class="uploadContent-infop">1、点击下载<span @click="downloadTemplate" class="templet">《导入打卡记录模板》</span></p>
